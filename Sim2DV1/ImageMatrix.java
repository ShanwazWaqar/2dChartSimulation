...
//
import javax.script.ScriptEngineManager; //Added by Fang Zhou 12/12/20
import javax.script.ScriptEngine; //Added by Fang Zhou 12/12/20
import javax.script.ScriptException; //Added by Fang Zhou 12/12/20
class ImageMatrix extends Canvas
{
//	Added by Fang Zhou 12/12/20
	ScriptEngineManager scriptEngineManager = new ScriptEngineManager();
	ScriptEngine scriptEngine = scriptEngineManager.getEngineByName("scriptEngine");
...
// end
	...
	public ImageMatrix()
		...
		public String simulate ( double d, double d1, double d2, double d3, double d4, double d5, double cs, int sf,
		int itrNo)
		{
			iterationNo = itrNo;
