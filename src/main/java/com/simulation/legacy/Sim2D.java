...
public class Sim2D {
	...
	public Sim2D(String noRows, String noColumns, String param1, String param2, String param3, String param4, String constant, String stressfact, String noIterations, String path) {
		this.noRows = noRows;
	...
	private void zipSimulationFiles() throws IOException {
		...
		try (FileOutputStream dest = new FileOutputStream(path + "files/simFiles.zip");
