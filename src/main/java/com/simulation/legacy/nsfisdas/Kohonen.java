...
public class Kohonen
{
 ...
 public void TrainKohonen()
 {
   try
   {
    File file = new ClassPathResource("legacy-resources/nsfisdas/" + trainFileName).getFile();
    FileInputStream in = new FileInputStream(file);
    input = new DataInputStream(in);
   }
   catch ( FileNotFoundException e)
   {
    System.out.println(" File not found: " + trainFileName);
   }
   catch ( IOException e)
   {
 ...
 if ( random) 
  ...
  while( !end )
  {
   ...
   input.close();
    ...
    {
     System.out.println(" IO Exception while closing training file: " + ex.getMessage());
    }
  ...
  try 
   {
    ...
    File outputFile = new File(centerFileName);
   ...
   {
    System.out.println(" Could not open centerfile to write: " + centerFileName);
   // System.exit(0);
   }
   catch ( IOException e)
   {
    System.out.println(" IOException opening centerfile to write: " + e.getMessage()); 
   // System.exit(0);
   }
  }
 ...
 private void closeCenterFile()
 {
  ...
  centerFile.close();
    ...
    {
     System.out.println(" IO Exception while closing center file: " + ex2.getMessage());
    }
 }
 ...
 private void setCenters()
 {
  ...
  try
  {
   File file = new ClassPathResource("legacy-resources/nsfisdas/" + centerFileName).getFile();
   FileInputStream centerFileStream = new FileInputStream(file);
   centerFile = new DataInputStream( centerFileStream );
  }
  catch ( IOException e)
  {
    System.out.println(" IO Exception reading center file: " + e.getMessage());
    random = true;
 ...
 while( clustersRead != clusters)
  {
   ...
   {
    System.out.println("Error: Center Initialization 1 - EOF reached");
    break;
   }
   catch (IOException ex)
   {
    System.out.println(" Error:IO Exception during center initialization: " + ex.getMessage());
    break;
   }
   clustersRead++;
  }
  ...
  // initialize numMembers, minVectors and MaxVectors
   ...
   {
    System.out.println("Error: Center Initialization 2 - EOF reached");
   }
   catch (IOException ex)
   {
    System.out.println(" Error:IO Exception during center initialization: " + ex.getMessage());
 ...
 private void setMinMax()
 {
  ...
  try
  {
   input.close();
    ...
    {
     System.out.println(" IO Exception while closing after setMinMax: " + ex2.getMessage());
    }
 } //func
