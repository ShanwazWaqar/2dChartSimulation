...
public class BPFeat
{
 ...
 public void OpenandReadintoMat()
 {
  try
  {
   File file1 = new ClassPathResource("legacy-resources/nsfisdas/DC91").getFile();
   FileInputStream fileStream1 = new FileInputStream(file1);
   matfile1 = new DataInputStream( fileStream1 );

   File file2 = new ClassPathResource("legacy-resources/nsfisdas/DC92").getFile();
   FileInputStream fileStream2 = new FileInputStream(file2);
   matfile2 = new DataInputStream( fileStream2 );
  
   File file3 = new ClassPathResource("legacy-resources/nsfisdas/DC93").getFile();
   FileInputStream fileStream3 = new FileInputStream(file3);
   matfile3 = new DataInputStream( fileStream3 );

   File file4 = new ClassPathResource("legacy-resources/nsfisdas/DC94").getFile();
   FileInputStream fileStream4 = new FileInputStream(file4);
   matfile4 = new DataInputStream( fileStream4 );
  
   File file5 = new ClassPathResource("legacy-resources/nsfisdas/DC95").getFile();
   FileInputStream fileStream5 = new FileInputStream(file5);
   matfile5 = new DataInputStream( fileStream5 );
   
  }
  catch( FileNotFoundException e)
  {
   System.out.println(" File not Found : matfile - " + e.getMessage());
//   System.exit(1);
  }
  catch( IOException e)
  {
   System.out.println(" IO Exception opening files: " + e.getMessage());
  }
  try
  {
   ...
   for (int i=0; i < rows3; i++)
    ...
    {  
      System.out.println(" IO exception: reading matfiles - " + e.getMessage());
   //   System.exit(1);
    }
   ...
   {
    System.out.println(" IO Exception during closing: " + ex.getMessage());
   }
