...
private void openFiles()
 {
  try
  {
   File inputFile = new ClassPathResource("legacy-resources/nsfisdas/" + inputFileName).getFile();
   File outputFile = new ClassPathResource("legacy-resources/nsfisdas/" + outputFileName).getFile();
