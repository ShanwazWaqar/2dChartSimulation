...
int j;
 ...
 private void openFiles()
 {
  try
   {
    File pcFileResource = new ClassPathResource("legacy-resources/nsfisdas/" + PCFile).getFile();
    File coeffsFileResource = new ClassPathResource("legacy-resources/nsfisdas/" + CoeffsFile).getFile();
    
    pcFile = new RandomAccessFile(pcFileResource, "r");
    coeffsFile = new RandomAccessFile(coeffsFileResource, "r");
   }
