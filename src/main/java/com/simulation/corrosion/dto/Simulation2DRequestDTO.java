...
public class Simulation2DRequestDTO {
    ...
    public int getNoColumns() { return noColumns; }
    public void setNoColumns(int noColumns) { this.noColumns = noColumns; }
    ...
    public void setParam3(double param3) { this.param3 = param3; }
    ...
    public int getStressFact() { return stressFact; }
    public void setStressFact(int stressFact) { this.stressFact = stressFact; }
    public int getNoIterations() { return noIterations; }
    public void setNoIterations(int noIterations) { this.noIterations = noIterations; }
